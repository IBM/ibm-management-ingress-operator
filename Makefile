...
install: ## Install all resources (CR/CRD's, RBCA and Operator)
	...
	@echo ....... Creating CR .......
	- kubectl apply -f deploy/crds/operator.ibm.com_v1_managementingress_cr.yaml -n ${NAMESPACE}

uninstall: ## Delete all that performed in $ make install
	@echo ....... Deleting CR .......
	- kubectl delete -f deploy/crds/operator.ibm.com_v1_managementingress_cr.yaml -n ${NAMESPACE}
